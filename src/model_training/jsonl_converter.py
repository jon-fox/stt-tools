...
# eventually this will be passed in as an argument
OUTPUT_JSONL_NAME = "transcript_0.jsonl"
...
jsonl_output_dir = os.path.join(current_dir, '..', '..', 'output_jsonl')
output_file_path = os.path.join(current_dir, '..', '..', 'output_jsonl', OUTPUT_JSONL_NAME)
